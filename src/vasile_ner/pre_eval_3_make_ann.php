...
$fname_in="../EVALUATE/gold/subtrack1/radu_dev_2";
$fname_out="../EVALUATE/system/subtrack1/baseline_radu_2";
...
while (($file = readdir($dh)) !== false) {
	...
	if(!is_file("${fname_in}/${fbase}.txt.tab.ann.vasilener")){
	    echo "ERROR ************* $file\n";
	    continue;
	}
	echo "$file\n";
	...
	$currentEntityType="O";
	$currentStart=0;
	foreach(explode("\n",file_get_contents("${fname_in}/${fbase}.txt.tab.ann.vasilener")) as $line){
	    $line=trim($line);
